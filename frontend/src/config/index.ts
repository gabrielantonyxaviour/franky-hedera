...
export const projectId = process.env.NEXT_PUBLIC_REOWN_PROJECT_ID || '2b1e04f4-3198-42a3-bbf1-ec5c19366cb8'
...
const base = defineChain({
  ...
  rpcUrls: {
    default: {
      http: [`https://base-mainnet.nodit.io/${process.env.NEXT_PUBLIC_NODIT_API_KEY}`],
    },
  },    
  blockExplorers: {
    default: { 
...
export const networks = [sepolia, base] as any
...
export const wagmiAdapter = new WagmiAdapter({
  ...
  transports: {
    [mainnet.id]: http(),
    [sepolia.id]: http(),
    [base.id]: http(`https://base-mainnet.nodit.io/${process.env.NEXT_PUBLIC_NODIT_API_KEY}`)
  }
})
