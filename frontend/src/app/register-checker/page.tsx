            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-400">
                  This is where your checker node will run. Must be accessible
                  via HTTPS.
                </p>
              </div>
              ...
              {registrationComplete && (
                <div className="mt-4 p-4 bg-emerald-900/20 border border-emerald-500/30 rounded-lg">
                  <p className="text-emerald-400">
                    Registration successful! Follow these steps to start your
                    node:
                  </p>
                  <ol className="mt-4 space-y-4 text-gray-300">
                    <li className="flex items-start">
                      <span className="flex-shrink-0 h-6 w-6 rounded-full bg-emerald-900/50 flex items-center justify-center mr-3">
                        1
                      </span>
                      <div>
                        ...
                        <code className="block mt-2 p-2 bg-black/50 rounded">
                          git clone
                          https://github.com/gabrielantonyxaviour/franky-hedera.git
                        </code>
                      </div>
                    </li>
                    <li className="flex items-start">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            <div className="p-6 bg-black/50 backdrop-blur-sm border border-[#00FF88]/30 rounded-xl">
              ...
              <p className="text-gray-400">
                Earn rewards for each successful device verification you
                perform.
              </p>
            </div>
            ...
            <div className="p-6 bg-black/50 backdrop-blur-sm border border-[#00FF88]/30 rounded-xl">
              ...
              <p className="text-gray-400">
                Help build a trustless verification layer for the Franky
                network.
              </p>
            </div>
