      ...
      if (accountId) {
        ...
        if (parseFloat(formattedBalance) < 1) {
          toast.info("Funding wallet", {
            description:
              "Your wallet balance is low to use Franky. Funding with 5 HBAR",
          });
    ...
    (async function () {
      try {
        ...
        if (serverWallet[0] == zeroAddress) {
          ...
          const { ciphertext, dataToEncryptHash } = await encryptServerWallet(
            serverWalletAddress,
            privateKey
          );
          let keypair = {
        ...
        toast.error("Transaction Failed", {
          description:
            "Invalid Transaction Data or wallet address already configured",
        });
      }
    })();
  }, [accountId, balance]);
              ...
              >
                {isLoading ? (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#00FF88]/70">{`HBAR`}</span>
                ...
                {accountId && (
                  ...
                  >
                    ...
                    <p className="cursor-pointer">
                      {shortenAddress(accountId as `0x${string}`)}
                    </p>
