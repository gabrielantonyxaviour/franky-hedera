...
export default function ConstructionZone({ selectedTools, onRemoveTool }: ConstructionZoneProps) {
  ...
  return (
    <div
      ref={setNodeRef}
      className={`p-6 rounded-xl cyberpunk-border bg-black/70 backdrop-blur-md h-[500px] relative overflow-hidden ${isOver ? 'border-[var(--primary-green)] ring-2 ring-[var(--primary-green)]/30' : ''
        }`}
    >
